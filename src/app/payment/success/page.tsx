    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen text-center p-10">
            ...
            <p className="text-lg text-white">
                Your payment was successfully. You can now start using the app.
                <br/>
                <span>
                    Your payment ID is:
                </span>
                ...
                <br/>
                <br/>
                <Link className="cursor-pointer mt-5 text-gray-900 bg-gradient-to-r
                                 ...
                                 text-center me-2 mb-2" href="/protected/chat">Return to chat</Link>
